...
if ( ! function_exists( 'reborn_posted_on' ) ) :
/**
 * Prints HTML with meta information for the current post-date/time and author.
 */
function reborn_posted_on() {
	...
	echo '<span class="posted-on">' . reborn_time_link() . '</span><span class="byline"> ' . $byline . '</span>';
}
endif;


if ( ! function_exists( 'reborn_time_link' ) ) :
/**
